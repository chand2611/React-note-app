  ...
  return (
    <div className="m_popup">
      ...
      <div className="m_popup_input">
        <span className="span_group">Group Name</span>
        <input
          value={groupName}
      ...
      <div className="m_popup_choose_color">
        <span className="span_color">Choose Color</span>
        <div className="m_popup_color">
          <div className={"m_popup_color_1"} onClick={handleColor}></div>
          <div className={"m_popup_color_2"} onClick={handleColor}></div>
          <div className={"m_popup_color_3"} onClick={handleColor}></div>
          <div className={"m_popup_color_4"} onClick={handleColor}></div>
          <div className={"m_popup_color_5"} onClick={handleColor}></div>
          <div className={"m_popup_color_6"} onClick={handleColor}></div>
        </div>
      </div>
